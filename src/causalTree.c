 ...
 *      alpha = weight parameter for error function, if alpha=1, equivalent to CT-adaptive, if alpha=0.5, equivalent to CT-honest.
 *
        ...
        SEXP xvar2, SEXP split_alpha2, SEXP cv_alpha2, SEXP NumHonest2, SEXP censoringProb2, SEXP completeCase2)
{
    ...
    partition(1, tree, &temp, 0, n, minsize, split_Rule, split_alpha, bucketnum, bucketMax,
              train_to_est_ratio); // temp stores sumrisk
