...
extern void CTss(int n, double *y[], double *value, double *tr_mean, double *con_mean, double *risk,
                 double *wt, double *treatment, double max_y, double alpha, double train_to_est_ratio, double * propensity);
...
extern int USER2init(int n, double *y[], int maxcat, char **error,
                  int *size, int who, double *wt, double *treatment, int bucketnum,
                  int bucketMax, double *train_to_est_ratio);
extern void USER2ss(int n, double *y[], double *value, double *tr_mean, double *con_mean, double *risk,
                 double *wt, double *treatment, double max_y, double alpha, double train_to_est_ratio, double * propensity);
extern void USER2(int n, double *y[], double *x, int nclass,int edge, double *improve, double *split,
               int *csplit, double myrisk, double *wt, double *treatment, int minsize, double alpha,
               double train_to_est_ratio, double *propensity);
extern double USER2pred(double *y, double wt, double treatment, double *yhat, double propensity);

extern int USER3init(int n, double *y[], int maxcat, char **error,
                     int *size, int who, double *wt, double *treatment, int bucketnum,
                     int bucketMax, double *train_to_est_ratio);
extern void USER3ss(int n, double *y[], double *value, double *tr_mean, double *con_mean, double *risk,
                    double *wt, double *treatment, double max_y, double alpha, double train_to_est_ratio, double * propensity);
extern void USER3(int n, double *y[], double *x, int nclass,int edge, double *improve, double *split,
                  int *csplit, double myrisk, double *wt, double *treatment, int minsize, double alpha,
                  double train_to_est_ratio, double *propensity);
extern double USER3pred(double *y, double wt, double treatment, double *yhat, double propensity);

extern int USER4init(int n, double *y[], int maxcat, char **error,
                     int *size, int who, double *wt, double *treatment, int bucketnum,
                     int bucketMax, double *train_to_est_ratio);
extern void USER4ss(int n, double *y[], double *value, double *tr_mean, double *con_mean, double *risk,
                    double *wt, double *treatment, double max_y, double alpha, double train_to_est_ratio, double * propensity);
extern void USER4(int n, double *y[], double *x, int nclass,int edge, double *improve, double *split,
                  int *csplit, double myrisk, double *wt, double *treatment, int minsize, double alpha,
                  double train_to_est_ratio, double *propensity);
extern double USER4pred(double *y, double wt, double treatment, double *yhat, double propensity);

extern int USER5init(int n, double *y[], int maxcat, char **error,
                     int *size, int who, double *wt, double *treatment, int bucketnum,
                     int bucketMax, double *train_to_est_ratio);
extern void USER5ss(int n, double *y[], double *value, double *tr_mean, double *con_mean, double *risk,
                    double *wt, double *treatment, double max_y, double alpha, double train_to_est_ratio, double * propensity);
extern void USER5(int n, double *y[], double *x, int nclass,int edge, double *improve, double *split,
                  int *csplit, double myrisk, double *wt, double *treatment, int minsize, double alpha,
                  double train_to_est_ratio, double *propensity);
extern double USER5pred(double *y, double wt, double treatment, double *yhat, double propensity);
//*/
...
static struct {
    ...
    {USER2init, USER2, USER2ss, USER2pred},
    {USER3init, USER3, USER3ss, USER3pred},
    {USER4init, USER4, USER4ss, USER4pred},
    {USER5init, USER5, USER5ss, USER5pred},
};
