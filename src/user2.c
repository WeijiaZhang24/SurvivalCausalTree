...
int
  USER2init(int n, double *y[], int maxcat, char **error,
...
void USER2ss(int n, double *y[], double *value,  double *con_mean, double *tr_mean,
...
void USER2(int n, double *y[], double *x, int nclass, int edge, double *improve, double *split,
...
double
  USER2pred(double *y, double wt, double treatment, double *yhat, double propensity)
  {
    double ystar;
    double temp;
