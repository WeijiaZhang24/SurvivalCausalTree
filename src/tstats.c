    ...
    if (nclass == 0) {
        ...
        for (i = 0; right_n > edge; i++) {
            ...
            if (x[i + 1] != x[i] && left_n >= edge &&
                ...
                t2 = 1 / left_tr + 1 / (left_wt - left_tr) + 1 / right_tr + 1 / (right_wt - right_tr);
                t3 = left_tr_var * (left_tr - 1) / t1 + left_con_var * (left_wt - left_tr - 1) / t1
                      + right_tr_var * (right_tr - 1) / t1 + right_con_var * (right_wt - right_tr - 1) / t1;
